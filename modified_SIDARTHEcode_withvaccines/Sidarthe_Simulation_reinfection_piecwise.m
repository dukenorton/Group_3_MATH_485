...
for i=2:length(t)
    ...
    %The code for piecewise vaccination
    if (i>5/step)
        phi=0.00001;
    elseif (i>50/step)
        phi=0.00005;
   ...
   % x=x+B*x*step;
    B=[-alfa*x(2)-beta*x(3)-gamma*x(4)-delta*x(5)-phi*x(1) 0 0 0 0 0 0 rein 0 rein_vacc 0;
...
figure
plot(t,Infetti_reali,'b',t,I+D+A+R+T,'r',t,H,'g',t,E,'k',t,V,'--black',"LineWidth",2.5)%added V
hold on
...
title('Epidemic Evolution with Reinfection and Piecewise Vaccination')
xlabel('Time (days)')
