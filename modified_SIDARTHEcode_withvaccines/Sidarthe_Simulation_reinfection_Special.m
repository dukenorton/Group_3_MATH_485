...
%Define the vaccination function that will calculate how people are
%vaccinated
%Try sinusoidal and guassian
vacc_1 = @(x) 0.05*sin(0.7*x)+0.1; %Could do +0.05 too
...
for i=2:length(t)
    ...
    phi = vacc_1(i/step); % may need the /step
...
%Plot the vaccination function to check it
%phi=vacc_1(i/step);
%phi=vacc_2(i/step);
figure
plot(t,vacc_1(t))
